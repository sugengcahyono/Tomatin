...
class DetailBeratMentahScreen extends StatefulWidget {
  ...
  @override
  State<DetailBeratMentahScreen> createState() =>
      _DetailBeratMentahScreenState();
}

class _DetailBeratMentahScreenState extends State<DetailBeratMentahScreen> {
  ...
  Future<void> _fetchRiwayatDetail_Pcs() async {
    final result = await apiService.getRiwayatDetailTomat_Pcs(
        widget.tanggal,
        widget.kloter,
        'Mentah'); // Sesuaikan dengan kategori yang ingin ditampilkan

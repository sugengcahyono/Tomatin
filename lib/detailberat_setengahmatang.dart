...
class DetailBeratSetengahMatangScreen extends StatefulWidget {
  ...
  @override
  State<DetailBeratSetengahMatangScreen> createState() =>
      _DetailBeratSetengahMatangScreenState();
}

class _DetailBeratSetengahMatangScreenState extends State<DetailBeratSetengahMatangScreen> {
  ...
  Future<void> _fetchRiwayatDetail_Pcs() async {
    final result = await apiService.getRiwayatDetailTomat_Pcs(
        widget.tanggal,
        widget.kloter,
        'Setengah Matang'); // Sesuaikan dengan kategori yang ingin ditampilkan
